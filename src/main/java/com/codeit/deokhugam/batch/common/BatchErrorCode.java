...
public enum BatchErrorCode {
  ...
  // Notification Batch 관련 에러
  NOTIFICATION_DELETION_FAILED(1003, "알림 삭제(ItemWriter) 실행 중 오류가 발생했습니다: %s"),
  NOTIFICATION_READ_FAILED(1004, "알림 조회(ItemReader) 실행 중 오류가 발생했습니다: %s");
